...
jQuery(function ($) {
    ...
    //     var obj ={ name : name, email : email , phone : phone, city : city , country : country ,type : bloodtype, notify : true};
    //      $.ajax({
    //             url: "/savedata",
    //             type: "get",
    //             data: obj
    ...
    $('#btn_login').click(function(){
        ...
        $('#alreadysignup').css("display",'block');
    ...
    $('#btn_signup').click(function(){
        ...
        $('#alreadysignup').css("display",'none');
    });
