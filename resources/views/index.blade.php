...
@include('layouts.nav')
                    ...
                    <div class="slider-content text-center">
                        <div class="container">
                            ...
                            <div class="slider-contents-info">
                                ...
                                <a href="/login" class="btn btn-slider">Donate Now <i class="fa fa-long-arrow-right"></i></a>
                    ...
                    <div class="slider-content text-center">
                        <div class="container">
                            <div class="slider-contents-info">
                                ...
                                <a href="/login" class="btn btn-slider">Join With Us <i class="fa fa-long-arrow-right"></i></a>
                            </div><!-- /.slider-content -->
                        </div> <!-- end .slider-contents-info  -->
                    </div>
            ...
            <div class="container-fluid" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h2 class="section-heading"><span>Looking</span> For Savers?</h2>
                        <p class="section-subheading"></p>
                    </div> <!-- end .col-sm-10  -->                    

                </div> <!--  end .row  -->

                <div class="row wow fadeInUp" id="vue-app" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="cta-content text-center">
                            ...
                            <a class="btn-cta-3" href="/login">Become Volunteer</a>
                        </div>
                    </div> <!-- end .col-md-12 -->
                </div> <!-- end .row  -->
            </div> <!-- end .container  -->
        ...
        <script type="x-template" id="search-component">
            <div class="container" style="padding:20px;border:1px solid #ddd;box-shadow: 1px 1px 1px #ddd;">
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <select class="form-control" v-model="t">
                                <option value="">select</option>
                                <option v-for="(type,index) in types" :key="index" v-html="type"></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    <button @click="search()" type="button" class="btn btn-info" style="border:#FE3C47;background:#FE3C47">
